...
const ZH_CONTENT = {
  ...
  glory: {
    work: {
      title_zh: "黑暗榮耀 (The Glory)",
      author_zh: "金銀淑 編劇 · Netflix",
      era_zh: "現代",
      summary_zh: "校園暴力受害者文東恩耗費多年精心策劃，一步步向加害者展開復仇的復仇劇。忠北清州中央公園、龍華寺等真實場景，成就了劇中幾個關鍵時刻。"
    },
    locations: {
      cheongjujungangpark: { modernName_zh:"清州中央公園（忠北清州市上黨區南寺路117）", tag_zh:"實際拍攝地 — 圍棋場景實際拍攝地", description_zh:"東恩與汝正相對而坐下圍棋的場景實際拍攝地。公園中央樹齡900年的銀杏樹下，東恩混在老人們之中學習圍棋的畫面就在此取景。清州映像委員會官方確認的拍攝地——直指之城清州，這次成了復仇劇真正的舞台。", travelTip_zh:"銀杏樹位於公園中心，很容易找到。步行即可連接聖安街。" },
      yonghwasa: { modernName_zh:"龍華寺（忠北清州市西院區無心西路565）", tag_zh:"實際拍攝地 — 宗教・家族場景實際拍攝地", description_zh:"位於無心川畔的大韓佛教曹溪宗寺院，劇中宗教與階級、加害者家族偽善交織的場景就在此實際拍攝，經清州映像委員會資料確認。目前仍是正常運作的寺院，參觀時請尊重這裡作為禮佛、修行空間的性質。", travelTip_zh:"這裡仍是正常運作中的寺院，參觀請保持安靜。從清州市區可搭公車前往。" },
      seongangil: { modernName_zh:"聖安街・清州舊市中心（忠北清州市上黨區聖安路）", tag_zh:"相關地點 — 舊市中心串聯景點", description_zh:"與清州中央公園、龍華寺相連的清州舊市中心商圈，因曾是朝鮮時代清州邑城內的主要道路而得名。雖非劇中特定場景，卻是從中央公園步行可達、能完成「黑暗榮耀拍攝地巡禮」的實際據點，也是與《非常律師禹英禑》（忠北道廳）串聯成清州K劇整合路線的核心連接點。", travelTip_zh:"從清州中央公園步行5分鐘以內即達，也直接連接清州地下商街。" },
      cheongnabadukpark: { modernName_zh:"青蘿湖水公園圍棋公園（仁川西區青蘿湖水路）", tag_zh:"實際拍攝地 — 大型圍棋盤造景實際拍攝地", description_zh:"兩座258平方公尺的大型圍棋盤與石雕造景，實際搭建於這座公園並在此取景，是有別於清州中央公園銀杏樹場景的另一處真實圍棋相關拍攝地。劇集播出後成為粉絲熱門造訪地，就位於青蘿樓涼亭旁。", travelTip_zh:"青蘿湖水公園範圍廣闊，建議以青蘿樓涼亭為地標尋找。" },
      jongno_pagoda: { modernName_zh:"鍾路3街圍棋街（首爾鍾路區敦化門路一帶）", tag_zh:"實際拍攝地 — 圍棋院場景拍攝地附近", description_zh:"塔谷公園附近，聚集著首爾多間老字號圍棋院的街區。據悉劇中東恩初次見到延鎮丈夫道英的圍棋院場景就在此一帶拍攝。是首爾市中心至今仍保留舊式圍棋文化的實際場所。", travelTip_zh:"從鍾路3街站步行可達，目前仍有多間圍棋院實際營業中。" },
      sejongbangok: { modernName_zh:"世宗市盤谷洞新都市一帶", tag_zh:"相關地點 — 新都市拍攝關聯地區（建築未特定）", description_zh:"世宗市新開發的新都市地區，據悉劇中部分學校、住宅場景在此一帶拍攝。惟為保護真實學生與設施，本站不特定標示校園暴力場景發生的具體建築（如學校、禮堂等），僅介紹新都市規劃街景本身。", travelTip_zh:"比起尋找特定建築，更建議欣賞新都市整體的規劃景觀。" },
      sodolbangpaje: { modernName_zh:"所乭防波堤（江原道江陵市注文津邑注文里791-47）", tag_zh:"實際拍攝地 — 第二季結局場景實際拍攝地", description_zh:"第二季最終回，飄雪的夜晚東恩與汝正倚著紅色燈塔喝啤酒、重新確認彼此心意的場景實際拍攝地。故鄉在江陵的編劇金銀淑，向來以把家鄉真實景點融入作品聞名，這座防波堤正是其中之一。就在連接兒岩公園的所乭海岸散步道旁。", travelTip_zh:"從注文津海水浴場開車約5分鐘。找到有紅色燈塔的所乭港防波堤即可。" }
    }
  },

  woo: {
    work: {
      title_zh: "非常律師禹英禑 (Extraordinary Attorney Woo)",
      author_zh: "文智元 編劇 · ENA·Netflix",
      era_zh: "現代",
      summary_zh: "描寫具自閉症類群特質的天才新人律師禹英禑，在首爾「汪洋律師事務所」成長歷程的法庭劇。江南Centerfield旋轉門、水原行宮洞等首爾・首都圈的真實拍攝地，構成了她的日常場景。"
    },
    locations: {
      hanbadabuilding: { modernName_zh:"Centerfield West（首爾江南區德黑蘭路231號）", tag_zh:"實際拍攝地 — 汪洋旋轉門場景實際拍攝地", description_zh:"劇中法律事務所「汪洋」辦公室旋轉門的實際拍攝地。害怕旋轉門的英禑，在同事李浚浩的協助下如跳華爾滋般通過旋轉門的場景，就在這棟大樓大廳實際拍攝。現實中是韓國遊戲公司等進駐的辦公大樓，如劇中設定般位於驛三站附近。", travelTip_zh:"從驛三站步行可達。這裡是實際使用中的辦公大樓，拍攝大廳時請留意其他訪客。" },
      gimbapplace: { modernName_zh:"風車（水原市八達區新豐路23街61號）", tag_zh:"實際拍攝地 — 「禹英禑紫菜飯捲店」實際拍攝地", description_zh:"劇中英禑父親禹光鎬所經營的「禹英禑紫菜飯捲」實際拍攝地。是位於水原行宮洞咖啡街（行理團街）的一間真實日式料理店，店名為「風車」，但與劇中不同，實際菜單上並沒有紫菜飯捲，賣的是烏龍麵與蓋飯。外觀與多處室內場景都在這間餐廳拍攝。", travelTip_zh:"這裡是實際營業中的餐廳，造訪時請安靜拍照，避免打擾其他客人。" },
      suwonhaenggung: { modernName_zh:"水原行宮洞行理團街（京畿道水原市八達區）", tag_zh:"相關地點 — 拍攝地周邊街區", description_zh:"「禹英禑紫菜飯捲店」拍攝地所在的咖啡街一帶，鄰近水原華城行宮。劇中實際出現的場景僅限於飯捲店拍攝地，但這一帶已成為訪客延伸「禹英禑拍攝地巡禮」的自然路線。", travelTip_zh:"步行可連接水原華城行宮，適合與城郭之旅一起安排。" },
      chungbukprovoffice: { modernName_zh:"忠清北道廳本館・庭園（忠北清州市上黨區上黨路82號）", tag_zh:"實際拍攝地 — 第8集「京海道廳」場景實際拍攝地", description_zh:"第8集劇中「京海道廳」場景的實際拍攝地。職員逃跑的室內場景在設有道議會的新館拍攝，走出建築物的場景則在本館入口取景，其後還出現道廳庭園與涼亭。本站將忠北標示為第8集小德洞相關場景的官方拍攝地，而非整部作品的背景。", travelTip_zh:"這裡是實際運作中的官署，平日上班時間以外庭園參觀可能受限。" },
      chungbukassembly: { modernName_zh:"忠清北道議會（忠北道廳新館內）", tag_zh:"實際拍攝地 — 第8集室內場景實際拍攝地", description_zh:"與忠北道廳本館相連的新館建築，是第8集劇中職員在室內逃跑場景的拍攝地。實際上是忠清北道議會使用的空間，經清州映像委員會資料確認為拍攝地。", travelTip_zh:"道議會內部一般開放區域有限，建議以外觀參觀為主。" },
      changwondongbu: { modernName_zh:"昌原東部村（慶南昌原市義昌區大山面北部里）", tag_zh:"實際拍攝地 — 「小德洞」實際拍攝村莊", description_zh:"劇中虛構村莊「小德洞」的實際取景村莊。第7、8集拍攝結束後，劇中出現的鯨魚壁畫至今仍留在村口住宅牆面，村莊象徵朴樹也仍實際佇立於此。這裡是面向洛東江大山平原的寧靜農村，請留意這是居民實際生活的空間。", travelTip_zh:"這裡是居民實際居住的村莊，請勿擅入私人土地，參觀朴樹與壁畫時請保持安靜。" },
      cheongjuoldtownlink: { modernName_zh:"清州中央公園・聖安街一帶（與《黑暗榮耀》拍攝地串聯）", tag_zh:"相關地點 — 清州整合旅遊路線連接點", description_zh:"從忠北道廳步行可達的清州舊市中心一帶，可與同樣位於清州的另一部作品《黑暗榮耀》的實際拍攝地（清州中央公園、龍華寺）串聯，形成「清州韓劇徒步整合路線」。雖非本劇直接出現的場景，但作為造訪忠北道廳後可自然延伸的實際動線而介紹於此。", travelTip_zh:"從忠北道廳步行約15～20分鐘。適合與《黑暗榮耀》拍攝地安排成一日路線。" }
    }
  },

  littleforest: {
    work: {
      title_zh: "小森林 (Little Forest)",
      author_zh: "林順禮 導演 · 原作 五十嵐大介",
      era_zh: "2018年上映",
      summary_zh: "教師任用考試落榜、厭倦首爾生活的惠媛回到故鄉，與青梅竹馬一起做當季食材料理、重新找回人生方向的療癒劇。大邱軍威郡「惠媛之家」拍攝結束後仍常態開放，是可實際造訪的空間。"
    },
    locations: {
      hyewonhouse: { modernName_zh:"惠媛之家（大邱軍威郡友保面美城5街58-1號）", tag_zh:"實際拍攝地 — 惠媛之家（列入官方觀光路線）", description_zh:"原本是空置的農家住宅，改造成拍攝場景後歷經一年拍攝。殺青後並未拆除，大廳、廚房、壁爐、醬缸台、菜園、腳踏車等劇中格局完整保留，常態對外開放。2023年5～6月經大邱市・大邱文化藝術振興院「I♥軍威」巡迴之旅試營運後，同年7月正式納入「軍威市區觀光」路線。", travelTip_zh:"免費入場，設有停車場。現場沒有洗手間，請事先準備。搜尋「美城1里村民會館」，距離約200公尺。" },
      hwabonstation: { modernName_zh:"花本站（慶北軍威郡山城面山城佳陰路711-9號）", tag_zh:"實際拍攝地 — 月台送別場景實際拍攝地", description_zh:"1936年通車的中央線近代小型車站。劇中載夏為前女友送行的月台場景在此拍攝，同時也兼作近代歷史展示館。", travelTip_zh:"門票1,000韓元。距惠媛之家車程約20分鐘。" },
      yeokjeonstore: { modernName_zh:"驛前商會（花本站前，軍威郡山城面）", tag_zh:"實際拍攝地 — 吃冰淇淋場景實際拍攝地", description_zh:"在花本站前經營超過50年的老雜貨店，惠媛與恩淑吃冰淇淋、懷舊零食的場景在此拍攝。至今仍實際營業，掛有「小森林拍攝地」的招牌。", travelTip_zh:"就在花本站正前方。這裡是實際營業中的商店，造訪時買點東西再走會更好。" },
      hanbamvillage: { modernName_zh:"韓密村石牆巷（軍威郡缶溪面）", tag_zh:"實際拍攝地 — 摘柿子場景實際拍攝地", description_zh:"惠媛摘柿子（紅柿）的場景實際拍攝地，是一座保留傳統石牆的村莊，以舊時石牆完整留存的靜謐風景聞名。", travelTip_zh:"從惠媛之家開車前往。建議放慢腳步，沿石牆小巷慢慢走。" },
      ilyeonpark: { modernName_zh:"一然公園（軍威郡孤老面）", tag_zh:"實際拍攝地 — 背景場景實際拍攝地", description_zh:"為紀念《三國遺事》作者一然禪師而建的公園，曾作為電影中的場景背景出現。", travelTip_zh:"適合與麟角寺一起造訪的寧靜公園。" },
      uiheungmarket: { modernName_zh:"義興傳統市場（軍威郡義興面）", tag_zh:"實際拍攝地 — 買菜場景實際拍攝地", description_zh:"惠媛一行人買菜的市場場景實際拍攝的真實傳統市場。", travelTip_zh:"從惠媛之家開車即可到達。" },
      jomunguksite: { modernName_zh:"召文國史蹟地（慶北義城郡金城面）", tag_zh:"實際拍攝地 — 春季背景場景實際拍攝地", description_zh:"保留古代召文國古墳群的史蹟地，也以油菜花田聞名，曾作為電影中春季場景的背景出現。", travelTip_zh:"春季油菜花盛開時造訪，最能看到與電影中相近的風景。" },
      sagokssansuyu: { modernName_zh:"義城沙谷面山茱萸村（慶北義城郡沙谷面）", tag_zh:"實際拍攝地 — 腳踏車散步場景實際拍攝地", description_zh:"惠媛騎腳踏車散步的場景實際拍攝地，是以早春黃色山茱萸花聞名的村莊。", travelTip_zh:"建議於3月底至4月初山茱萸花開時造訪。" },
      osangligarlic: { modernName_zh:"義城沙谷面吾上里蒜田（慶北義城郡沙谷面）", tag_zh:"實際拍攝地 — 春季田地場景實際拍攝地", description_zh:"2017年5月經媒體公開的春季場景拍攝地，是全國品牌價值數一數二的義城大蒜實際栽種地之一。", travelTip_zh:"這裡是實際耕作中的農田，請勿進入田地，於路邊欣賞風景即可。" },
      gunwimarket: { modernName_zh:"軍威傳統市場（軍威郡軍威邑）", tag_zh:"相關地點 — 軍威市區觀光連接景點", description_zh:"納入軍威市區觀光午餐行程的真實傳統市場，是造訪惠媛之家之餘，品嚐當地美食的好去處。", travelTip_zh:"透過軍威市區觀光預約管道造訪，可與其他行程一併安排。" },
      gunwijujube: { modernName_zh:"軍威棗子產地一帶（軍威郡全境）", tag_zh:"相關地點 — 軍威特產（非劇中提及題材）", description_zh:"軍威郡是全國名列前茅的紅棗產地，每年都會舉辦紅棗節。雖非劇中直接提及的題材，但作為惠媛之家所在地區的真實特產，值得一併介紹。", travelTip_zh:"秋季紅棗節期間造訪，可同時享受當地特產。" }
    }
  },

  priests: {
    work: {
      title_zh: "黑祭司 (The Priests)",
      author_zh: "張宰賢 導演",
      era_zh: "2015年上映",
      summary_zh: "金範信神父確信陷入昏迷的少女英信是被惡靈附身，於是找神學生崔富祭當助手，展開非正式驅魔儀式的驚悚片。大邱桂山聖堂、東城路等近代小巷一帶，是本片真正的拍攝地。"
    },
    locations: {
      gyesancathedral: { modernName_zh:"桂山聖堂（大邱中區西城路10號）", tag_zh:"實際拍攝地 — 桂山聖堂空拍・室內場景實際拍攝地", description_zh:"建於1902～1903年、韓國第三座哥德式聖堂（史蹟第290號）。劇中崔副祭進入聖堂取驅魔道具的空拍鏡頭、蒙席看電視的場景等皆在此拍攝。因外觀與首爾明洞聖堂相似，電影中將兩座聖堂的畫面交叉剪輯成同一座「明洞聖堂」。導演張宰賢曾在SBS新聞專訪中親自證實此拍攝協力事實。", travelTip_zh:"從大邱都市鐵路半月堂站步行10分鐘。也是近代小巷之旅第2路線的起點。" },
      wolbaechurch: { modernName_zh:"月背聖堂（大邱達西區月背路131-5號）", tag_zh:"實際拍攝地 — 英信回憶場景實際拍攝地", description_zh:"英信在唱詩班試唱時走音、明亮溫暖的過去回憶場景實際拍攝地。教堂內古老的尖塔與櫸樹庭院，與電影整體陰暗沉重的基調形成對比色彩。", travelTip_zh:"從大邱都市鐵路1號線月背站步行2～3分鐘。" },
      dongseongro: { modernName_zh:"東城路（大邱中區，舊大邱邑城原址）", tag_zh:"實際拍攝地 — 巷弄・住宅區場景實際拍攝地", description_zh:"有「大邱明洞」之稱的大邱最大鬧區。英信家附近的巷弄、崔副祭邊禱告邊走入的窄巷等場景皆在此一帶拍攝（與首爾明洞8街巷弄畫面交叉剪輯）。因曾是舊大邱邑城內的主要道路而得名。", travelTip_zh:"從半月堂站、中央路站一帶步行可達，自然銜接近代小巷路線。" },
      keimyungdaemyeong: { modernName_zh:"啟明大學大明校區（大邱南區明德路104號）", tag_zh:"實際拍攝地 — 神學院校園場景實際拍攝地", description_zh:"劇中崔副祭就讀的虛構「首爾天主教大學聖神校區」實際拍攝地。院長神父約談崔副祭與金範信神父的場景等皆在此拍攝。是一座擁有老建築、常被用作電影拍攝地的校園。", travelTip_zh:"從大邱都市鐵路明德站步行可達。" },
      catholicujustino: { modernName_zh:"大邱天主教大學儒斯定校區（大邱南區前山循環路393號）", tag_zh:"實際拍攝地 — 神學院校園場景實際拍攝地", description_zh:"與啟明大學大明校區一同交替用於「首爾天主教大學」神學院場景的實際校園。", travelTip_zh:"位於前山山腳，適合與啟明大學大明校區一起造訪。" },
      apsangolf: { modernName_zh:"前山一帶（大邱南區）", tag_zh:"相關地點 — 大邱拍攝地整合旅遊據點", description_zh:"環繞大邱市中心南側的山，啟明大學、天主教大學儒斯定校區等多處大邱拍攝地都聚集在其山腳一帶。雖非電影特定場景的拍攝地，卻是把大邱拍攝地以步行、開車方式串聯起來的地理基準點。", travelTip_zh:"可與前山纜車、觀景台一起安排成大邱拍攝地半日遊路線。" },
      banwoldang: { modernName_zh:"半月堂站一帶（大邱中區）", tag_zh:"相關地點 — 拍攝地移動據點", description_zh:"連接桂山聖堂、東城路、明德站的大邱舊市中心交通樞紐，是電影拍攝地巡禮實質上的轉乘據點。", travelTip_zh:"大邱都市鐵路1、2號線轉乘站，近代小巷路線的導覽處也在附近。" },
      yisanghwahouse: { modernName_zh:"李相和故居（大邱中區西城路）", tag_zh:"相關地點 — 近代小巷之旅連接景點（非電影場景）", description_zh:"位於桂山聖堂附近，包含在大邱近代小巷之旅第2路線內的真實文化遺產。是日治時期抵抗詩人李相和曾居住的房子，雖非電影場景，卻是與桂山聖堂拍攝地一同完成近代小巷路線的實際名勝。", travelTip_zh:"從桂山聖堂步行3分鐘。適合與徐相敦故居一起造訪。" },
      seosangdonhouse: { modernName_zh:"徐相敦故居（大邱中區桂山洞）", tag_zh:"相關地點 — 近代小巷之旅連接景點（非電影場景）", description_zh:"主導國債報償運動的徐相敦曾居住的房子。與桂山聖堂、李相和故居一同構成近代小巷之旅第2路線的真實名勝。", travelTip_zh:"步行即可連接桂山聖堂與李相和故居。" },
      daegunight: { modernName_zh:"桂山聖堂一帶夜景觀賞點", tag_zh:"相關地點 — 聖堂夜景", description_zh:"以桂山聖堂哥德式尖塔在燈光照射下格外動人的夜間景色聞名的地點。粉絲間常提及這裡是能親身感受電影中陰暗宗教氛圍的地方。", travelTip_zh:"日落後造訪能感受到與白天截然不同的氣氛。這裡是實際的宗教設施，參觀請保持安靜。" }
    }
  },

  moneyheist: {
    work: {
      title_zh: "紙房子 (La Casa de Papel／Money Heist，西班牙原版)",
      author_zh: "艾力克斯·平納 製作 · Netflix",
      era_zh: "現代",
      summary_zh: "人稱「教授」的策劃者召集以世界城市為代號的成員，對西班牙皇家鑄幣廠與中央銀行展開大規模搶劫行動。比起槍戰，時間、輿論、信任與內部衝突更為關鍵。"
    },
    locations: {
      csicmadrid: { modernName_zh:"CSIC總部（馬德里）", tag_zh:"實際拍攝地 — 鑄幣廠外觀實際拍攝地", description_zh:"劇中作為西班牙皇家鑄幣廠外觀出現的馬德里國家研究委員會（CSIC）建築。真正的皇家鑄幣廠（Fábrica Nacional de Moneda y Timbre）位於薩拉曼卡區狹窄且車流量大的街道上，實際上難以拍攝動作場面，加上是實際印製紙幣、鑄造硬幣的保安設施，內部拍攝也不被允許。相較之下，CSIC建築位於車輛通行受管制的區域，拍攝條件更加便利。鑄幣廠與銀行內部場景則另於科爾梅納爾別霍的攝影棚搭建。", travelTip_zh:"這裡是實際運作中的研究機構，僅能拍攝外觀。" },
      nuevosministerios: { modernName_zh:"新部會大樓（Nuevos Ministerios）", tag_zh:"實際拍攝地 — 中央銀行外觀實際拍攝地", description_zh:"用於部分中央銀行外觀場景拍攝的馬德里政府辦公建築群。", travelTip_zh:"這裡是實際運作中的政府辦公建築群，內部參觀受限。" },
      ministeriofomento: { modernName_zh:"發展部大樓（Ministerio de Fomento）", tag_zh:"實際拍攝地 — 行動相關背景實際拍攝地", description_zh:"作為劇中搶劫行動相關背景使用的馬德里歷史官署建築。", travelTip_zh:"鄰近阿托查車站，適合一併造訪。" },
      plazacallao: { modernName_zh:"卡亞俄廣場（Plaza del Callao）", tag_zh:"實際拍攝地 — 群眾場景・撒鈔場景實際拍攝地", description_zh:"劇中群眾與示威場景的實際拍攝地，位於馬德里市中心的代表性廣場，也是飛船在城市上空撒下鈔票這一經典畫面的真實背景地。", travelTip_zh:"與格蘭大道購物街相連。" },
      granvia: { modernName_zh:"格蘭大道（Gran Vía）", tag_zh:"實際拍攝地 — 馬德里市景實際拍攝地", description_zh:"馬德里代表性的鬧區大道，出現在劇中多處城市背景場景中。", travelTip_zh:"夜間燈光絢爛，也是知名的夜景景點。" },
      sanfrutos: { modernName_zh:"聖弗魯托斯隱修院（San Frutos Hermitage，塞哥維亞）", tag_zh:"實際拍攝地 — 訓練場景實際拍攝地", description_zh:"劇中作為團隊訓練場地出現的塞哥維亞近郊廢棄修道院。", travelTip_zh:"可同時欣賞杜拉頓峽谷的壯麗景色。" },
      torrelodones: { modernName_zh:"托雷洛多內斯（Torrelodones）", tag_zh:"實際拍攝地 — 教授藏身處實際拍攝地", description_zh:"設定為「教授」藏身處的馬德里近郊小鎮。", travelTip_zh:"可從馬德里搭近郊列車前往。" },
      florence: { modernName_zh:"佛羅倫斯（義大利）", tag_zh:"實際拍攝地 — 柏林相關回憶場景實際拍攝地", description_zh:"用於拍攝柏林相關回憶場景的義大利城市。", travelTip_zh:"是一座適合步行遊覽的城市，可順道參觀百花聖母大教堂。" },
      madridstudio: { modernName_zh:"馬德里攝影棚場景", tag_zh:"實際拍攝地 — 內部場景搭建地", description_zh:"鑄幣廠與銀行內部場景搭建拍攝的馬德里攝影棚。", travelTip_zh:"這裡是不對外開放的拍攝設施。" }
    }
  }
